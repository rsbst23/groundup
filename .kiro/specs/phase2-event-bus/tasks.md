...
- [x] 5. Add non-generic OperationResult to Core
  ...
  - [x]* 5.3 Write property test — Ok factory preserves inputs (Property 4)
  ...
  - [x]* 5.4 Write property test — Fail factory preserves inputs (Property 5)
  ...
  - [x]* 5.5 Write property test — Shorthand factories produce correct status codes (Property 6)
...
- [-] 6. Implement BaseEvent and InProcessEventBus tests
  - [x] 6.1 Write BaseEvent unit tests
  ...
  - [x]* 6.2 Write property test — BaseEvent EventId uniqueness (Property 1)
  ...
  - [x] 6.3 Write InProcessEventBus unit tests
  ...
  - [x]* 6.4 Write property test — All registered handlers are invoked (Property 2)
  ...
  - [x]* 6.5 Write property test — Handler fault isolation (Property 3)
