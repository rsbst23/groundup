...
/// <summary>
/// Request DTO for updating an existing setting definition. Replaces the
/// associated options and allowed levels with the values provided.
/// </summary>
...
/// <param name="Options">Optional collection of setting options for select-type settings.</param>
/// <param name="AllowedLevelIds">Optional collection of level IDs where this setting can be overridden.</param>
